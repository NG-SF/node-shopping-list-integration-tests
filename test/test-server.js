...
describe('Recipes', function() {
  ...
  //   2. inspect response object and prove it has right code and have
  //   right keys in response object.
  it('should list recipes on GET', function() {
    ...
    return chai
      ...
      .then(function(res) {
        ...
        res.body.length.should.be.at.least(1);
        // each item should be an object with key/value pairs for `id`, `name` and `ingredients`.
  ...
  it('should add a recipe on POST', function() {
    const newRecipe = { name: 'salad', ingredients: ['tomatoes', 'cucumbers', 'dill'] };
    return chai
      .request(app)
      .post('/recipes')
      .send(newRecipe)
  ...
  it('should update recipe on PUT', function() {
    ...
    const updateData = {
      name: 'salad',
      ingredients: ['tomatoes', 'cucumbers', 'dill']
    };
